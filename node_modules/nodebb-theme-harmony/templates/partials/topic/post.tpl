...
<div class="d-flex align-items-start gap-3">
	<div class="bg-body d-none d-sm-block rounded-circle" style="outline: 2px solid var(--bs-body-bg);">
		{{{ if ./isannonymous}}}
			<a class="d-inline-block position-relative text-decoration-none" href="">
				{buildAnonymousAvatar("48px", true, "avatar avatar-tooltip")}
			</a>
		{{{else}}}
	...
	<div class="post-container d-flex flex-grow-1 flex-column w-100" style="min-width:0;">
		<div class="d-flex align-items-center gap-1 flex-wrap w-100 post-header mt-1" itemprop="author" itemscope itemtype="https://schema.org/Person">
			<meta itemprop="name" content="{{{if ./isannonymous}}} annonymous {{{else}}} {./user.username} {{{ end }}}">
			{{{ if ./user.userslug}}}<meta itemprop="url" content="{config.relative_path}/user/{./user.userslug}">{{{ end }}}

			{{{if ./isannonymous}}}
				<div class="bg-body d-sm-none">
					<a class="d-inline-block position-relative text-decoration-none" href="">
						{buildAnnonymousAvatar("20px", true, "", "avatar avatar-tooltip")}
					</a>
				</div>
			{{{else}}}
				<div class="bg-body d-sm-none">
			...
			{{{if ./isannonymous}}}
				<a class="fw-bold text-nowrap" href="">annonymous</a>
			{{{else}}}
