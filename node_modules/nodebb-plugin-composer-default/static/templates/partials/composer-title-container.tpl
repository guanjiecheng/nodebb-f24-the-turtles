<div class="title-container align-items-center gap-2 d-flex">
	...
	<div  data-component="composer/post-anonymous" class="form-check ms-2">
		<input class="form-check-input post-anonymous form-control" type="checkbox" id="post-anonymous" data-action="toggle-anonymous">
	...
	<div data-component="composer/post-privately" component = "composer/post-privately">
		<button id="post-privately" class="btn btn-sm btn-link text-reset post-privately" aria-label="[[modules:composer.topic-privacy]]" data-action="toggle-privacy" data-state = "public">
