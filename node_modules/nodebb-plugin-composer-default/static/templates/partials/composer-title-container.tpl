<div class="title-container align-items-center gap-2 d-flex">
	...
	<div  data-component="composer/post-annonymous" class="form-check ms-2">
		<input class="form-check-input post-annonymous form-control" type="checkbox" id="post-anonymous" data-action="toggle-anonymous">
		<label class="form-check-label" for="post-anonymous">
			Post Annonymously
		</label>
	</div>
	<!-- End of Post Anonymous Checkbox -->
